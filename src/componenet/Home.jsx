...
import hero from '../assets/mee.png';
...
const Home = () => {
    return(
        ...
        from-black via-black to-gray-800 pt-14 px-20 ">
            ...
            md:flex-row">
                <div className="flex flex-col justify-center h-full">
                    ...
                    <div>
                        ...
                        flex item-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-600 cursor-pointer">
                            Portfolio
                ...
                <div>
                    <img src={hero} alt="me" className="rounded-2xl mx-auto w-2/3 md:w-full"/>
                </div>
            </div>
