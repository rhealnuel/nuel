...
const Contact = () => {
        return (
            <div name="contact" className="w-full h-full bg-gradient-to-b from-black to-gray-800 p-4 text-white lg:pt-24 ">
                ...
                <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full ">
                    ...
                    <div className="flex justify-center items-center">
                        <form action="https://getform.io/f/34fb9b67-51c9-4f1b-9814-23cd28be1635" method="POST" className="flex flex-col w-full md:w-1/2">
                            ...
                            bg-transparent border-2 rounded-md text-white focus:outline-none my-4"/>
